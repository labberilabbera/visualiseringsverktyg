      ...
      <div style={{ width: '100%', maxWidth: '360px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            background: '#1a56db', margin: '0 auto 1rem',
          ...
          <h1 style={{ fontSize: '1.25rem', fontWeight: 500, color: 'white', margin: 0 }}>
        ...
        <form onSubmit={handleLogin} style={{
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', fontSize: '0.75rem', color: '#888', marginBottom: '0.375rem' }}>
              E-post
            </label>
            <input
              type="email"
          ...
          {error && (
            <p style={{ color: '#f87171', fontSize: '0.8rem', marginBottom: '1rem', margin: '0 0 1rem' }}>
              {error}
            </p>
          )}
          <button
